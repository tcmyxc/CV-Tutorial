...
def get_imagenet32(data_root="~/datasets", random_erase_prob=0.0, auto_augment=False, cutout=False, **kwargs):
    ...
    # train, 1281167
    train_dataset = datasets.ImageFolder(data_root + '/ImageNet32/box', transform=train_transform)
    # val, 50000
    test_dataset = datasets.ImageFolder(data_root + '/ImageNet32/val/box', transform=val_transform)
