...
from layers import SequecialHGELUV4D

SequecialHGELUV4 = partial(SequecialHGELUV4D, r=16)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, act_layer=None,):
        ...
        self.aa = SequecialHGELUV4(out_channels * BasicBlock.expansion)
    ...
    def forward(self, x):
        ...
        out = out + self.aa(out)
        return self.act_layer()(out + self.shortcut(x))
...
class BottleNeck(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, act_layer=None,):
        ...
        self.aa = SequecialHGELUV4(out_channels * BottleNeck.expansion)
...
@register_model("rescnet50_mlp_c100")
