...
class BasicBlock(nn.Module):
    ...
    def __init__(
        ...
        self.norm_layer1 = norm_layer(planes)
        self.act = act_layer()
        self.conv2 = conv3x3(planes, planes)
        self.norm_layer2 = norm_layer(planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.norm_layer1 = norm_layer(width)
        self.conv2 = conv3x3(width, width, stride, groups, dilation)
        self.norm_layer2 = norm_layer(width)
        self.conv3 = conv1x1(width, planes * self.expansion)
        self.norm_layer3 = norm_layer(planes * self.expansion)
        self.act = act_layer()
        self.downsample = downsample
        self.stride = stride
...
class ResNet(nn.Module):
    def __init__(
        ...
        self.norm_layer1 = norm_layer(self.inplanes)
        self.act = act_layer()
...
@register_model("wide_resnet50_2_E5_C")
...
@register_model("wide_resnet101_2_E5_C")
