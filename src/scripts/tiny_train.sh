...
do
    for model in 'vgg16_c100' 'resnet50_c100' 'seresnet50_c100' 'resnext50_c100' 'preactresnet50_c100' 'shufflenetv2_c100'
    do
        for act in 'relu' 'gelu' 'hgelu'
        do
            CUDA_VISIBLE_DEVICES="0,1,2,3" torchrun --nproc_per_node=4  --master_port="28866" classification/train.py \
                --model_lib cifar100 \
                --model ${model} \
                --data_name ${dataset} \
                --batch-size 32 \
